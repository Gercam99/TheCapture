...
namespace  ExtensionsUnity
{
    ...
    public static class Extensions
    {
        ...
        public static bool HasArrived(NavMeshAgent agent) => agent.remainingDistance <= agent.stoppingDistance
                                                             && !agent.pathPending;

        public static void StopNavMesh(NavMeshAgent agent) => agent.isStopped = true;
        public static void PlayNavMesh(NavMeshAgent agent) => agent.isStopped = false;
